...
class HelloTriangleApplication {
   ...
   private:
    ...
    void drawFrame() {
        ...
        // TODO: think about why put it here
    ...
    void createLogicalDevice() {
        ...
        if (vkCreateDevice(physicalDevice, &createInfo, nullptr, &device) != VK_SUCCESS) {
            throw std::runtime_error("failed to createlogical device!");
        }
    ...
    void createSwapChain() {
        ...
        // * maxImageCount == 0 means there is no upper limit
        ...
        createInfo.imageArrayLayers = 1;  // * always 1 unless building stereocopic applications
    ...
    void createGraphicsPipeline() {
        ...
        vertShaderStageInfo.pName = "main";  // * Entry point function for shaders

        VkPipelineShaderStageCreateInfo fragShaderStageInfo{};
        fragShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        fragShaderStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
        fragShaderStageInfo.module = fragShaderModule;
        fragShaderStageInfo.pName = "main";  // * Entry point function for shaders
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.proj[1][1] *= -1;  // *Flip Y coordinate so that projection works with vulkan
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        // * Cannot append to a recorded command buffers, calling BeginCommandBuffer will implicitly
        // reset it.
    ...
    void createSyncObjects() {
        ...
        // * Workaround to solve the first frame dillema
    ...
    debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
        ...
        return VK_FALSE;  // should always return false
    }
